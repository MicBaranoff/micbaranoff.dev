...
$(document).ready(function(){
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      $('section.mainbanner .holder .info').addClass('wow fadeInUp');
      $('section.mainbanner .holder h1').addClass('wow fadeInUp');
      new WOW().init();
      
      }, 3100);

      let bg = document.querySelector('footer .holder .atom');
